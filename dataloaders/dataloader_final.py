...
class Loader(object):
    ...
    def generate(self):
        ...
        while True:
            ...
            gt_start = np.zeros((batch_size,self.max_frames),dtype=np.float32)
            gt_end = np.zeros((batch_size,self.max_frames),dtype=np.float32)
            ...
            for i in range(batch_size):
                ...
                gt_start[i,int(start_frame)] = 1.0
                gt_end[i,int(end_frame)] = 1.0
            ...
            yield frame_vecs, frame_n, ques_vecs, ques_n, labels, gt_windows, gt_start, gt_end
