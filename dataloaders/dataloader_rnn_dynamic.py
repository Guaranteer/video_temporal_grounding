        ...
        while True:
            ...
            for i in range(batch_size):
                ...
                if frame_num > self.max_frames:
                    ...
                    frame_num = self.max_frames
                # if frame_num > batch_max_frame:
                #     batch_max_frame = frame_num
                frame_n[i] = frame_num
                frame_vecs[i, :frame_num, :] = frames


                frame_per_sec = frame_num/duration
            ...
            # frame_vecs = frame_vecs[:,:batch_max_frame,:]
            # labels = labels[:,:batch_max_frame]
